export const services = [
  ...
  },
  {
    id: '02',
    header: 'Branding',
    body: 'We specialise in building brands that capture the heart and soul of each company. By taking the time to truly understand our clients, we create meaningful, authentic brands that resonate deeply with their audiences.',
  },
  {
    id: '03',
    header: 'Digital Marketing & Ads',
    body: 'Our passion is crafting graphic design that elevates brands and leaves a lasting impression. We love creating striking visuals that capture attention. From bespoke illustrations and dynamic motion design to standout marketing, we bring a unique approach to every project',
  },
  {
    id: '04',
